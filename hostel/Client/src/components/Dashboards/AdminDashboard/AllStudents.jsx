...
function AllStudents() {
  const getCSV = async () => {
    ...
    const res = await fetch("https://hostelmanagement-ju4x.onrender.com/api/student/csv", {
      method: "POST",
      headers: {
  ...
  const deleteStudent = async (id) => {
    const res = await fetch(
      "https://hostelmanagement-ju4x.onrender.com/api/student/delete-student",
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
  ...
  return (
    <div className="w-full h-screen flex flex-col gap-5 items-center justify-center">
      <h1 className="text-white font-bold text-5xl">All The Students</h1>
      <div className="w-96 flex justify-center">
        <button
          onClick={getCSV}
          target="_blank"
          download={true}
          className="px-20 py-3 bg-red-500 hover:bg-red-600 text-white font-bold rounded-xl shadow-xl"
        >
          The Download List
        </button>
        <ToastContainer
      ...
      <div className="bg-neutral-950 px-10 py-5 rounded-xl shadow-xl sm:w-[50%] sm:min-w-[500px] w-full mt-5 max-h-96 overflow-auto">
        <span className="text-white font-bold text-xl">All The Students</span>
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button
                        className="hover:underline hover:text-blue-500 hover:scale-125 transition-all"
