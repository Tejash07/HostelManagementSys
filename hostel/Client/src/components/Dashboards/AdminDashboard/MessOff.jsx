...
function MessOff() {
  const getRequests = async () => {
    ...
    console.log(hostel);
    const res = await fetch("https://hostelmanagement-ju4x.onrender.com/api/messoff/list", {
      method: "POST",
      headers: {
  ...
  const updateRequest = async (id, status) => {
    const res = await fetch("https://hostelmanagement-ju4x.onrender.com/api/messoff/update", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
