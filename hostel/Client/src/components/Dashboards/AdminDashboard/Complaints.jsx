...
function Complaints() {
  const getComplaints = async () => {
    ...
    const response = await fetch(`https://hostelmanagement-ju4x.onrender.com/api/complaint/hostel`, {
      method: "POST",
      headers: {
  ...
  const dismissComplaint = async (id) => {
    const response = await fetch(
      "https://hostelmanagement-ju4x.onrender.com/api/complaint/resolve/",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
