...
function Settings() {
  ...
  function ChangPass(e) {
    setPass(e.target.value);
  }

  function ChangOldPass(e) {
    ...
    <div className="w-full h-screen pt-20 flex flex-col items-center justify-center">
      ...
      <form method="POST" onSubmit={changePassword} >
        <div className="w-96 flex flex-col justify-between gap-5 bg-neutral-950 p-5 rounded">
          ...
          <Input field={ChangOldPassField} />
          <Input field={ChangPassField} />
          <button
            type="submit"
            className="w-full text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 mt-5 text-center"
          >
            Change Password
          </button>
          <ToastContainer
