...
import "chart.js/auto"; // is not working without it as it's the chart library for js
...
function Mess() {
  ...
  const loader = (
    <svg
      aria-hidden="true"
      className="inline w-4 h-4 mr-2 animate-spin text-white fill-red-600"
      viewBox="0 0 100 101"
      fill="none"
  ...
  return (
    <div className="w-full h-screen gap-10 flex flex-col items-center justify-center max-h-screen overflow-y-auto pt-[500px] sm:pt-96 md:pt-96 lg:pt-40">
      ...
      <div className="w-full gap-10 flex items-center justify-center flex-wrap">
        <div className="h-[30vh] gap-2 flex items-center justify-center flex-wrap">
          ...
          <ul className="text-white">
            ...
            <li className="flex gap-2">
              {" "}
              <span className="w-10 h-5 bg-red-500 block"></span> Mess Attended
            </li>
          </ul>
        </div>
      ...
      >
        ...
        <button
          type="submit"
          className="w-full text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-800 text-xl rounded-lg px-5 py-2.5 mt-5 text-center"
        >
          {loading ? (
