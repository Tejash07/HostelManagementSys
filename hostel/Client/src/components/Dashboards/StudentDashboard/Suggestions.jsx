...
function Suggestions() {
  const registerSuggestions = async (e) => {
    ...
    const response = await fetch("https://hostelmanagement-ju4x.onrender.com/api/suggestion/register", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="w-full h-screen flex flex-col gap-10 items-center justify-center max-h-screen overflow-y-auto">
      <h1 className="text-white font-bold text-5xl mt-5">Suggestion</h1>
      <form
        method="POST"
